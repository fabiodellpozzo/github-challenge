...
if (empty($id)) {
    ...
    $query_usuario = "SELECT id, nome_usuario, email_usuario FROM usuarios WHERE id=:id LIMIT 1";
...
<body>
    ...
    if (!empty($dados['EditarUsuario'])) {
        ...
        $query_edit_usuario = "UPDATE usuarios SET nome_usuario=:nome_usuario, email_usuario=:email_usuario, modified = NOW() WHERE id=:id";
